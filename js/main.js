...
(function() {
    ...
    // Simplified typing animation that works on all devices
    function initTypingAnimation() {
        // Disable typing animation - just show text immediately
    ...
    function initAnimations() {
        ...
        if (!prefersReducedMotion) {
            ...
            initTypingAnimation(); // This now just ensures text is visible
            initParallaxEffects();
